...
class MySQL
{
    ...
    // CARDS
        // RQ 1 Extraer datos para tabla de nuevos Registros
            ...
            public function modalRecNewRegister()
            {
                ...
                try {
                    $strQuery = "CALL sp_recNewRegisterModals()";
    ...
    // GRAFICOS Y MODALS 
        //RQ 5   Extraer datos para grafica de Barras
            public function comparativeBarGraph($year)
            {
                ...
                try {
                    $strQuery = "CALL sp_comparativeBarGraphInformation(:sp_year)";
                    ...
                    if ($this->conBDPDO()) {
                        ...
                        while ($row = $eQuery->fetch()) {
                            ...
                            $oData1->Laptops = $row['Laptops'];
                            $oData1->Escritorios = $row['Escritorios'];
                            $oData1->Total = $row['Total'];
        ...
        //RQ 6  Extraer datos para modal de la Tabla para el Grafico de Barras
        ...
        //RQ 7  Extraer datos para de la Grafica Pastel Desktop  
            public function pieGraphInformationDesktop($year)
            {
                $jDatosPie = '';
                ...
                try {
                    $strQuery = "CALL sp_pieGraphInformationDesktop(:sp_year)";
                    ...
                    if ($this->conBDPDO()) {
                        ...
                        while ($row = $eQuery->fetch()) {
                            $oDataP = new PieData();
                            $oDataP->Marca = $row['Marca'];
                            $oDataP->CantidadRegistrosMFC = $row['CantidadRegistrosMFC'];
        ...
        //RQ 8 Extraer datos para el modal del Grafica Pastel Desktop
                ...
                try {
                    ...
                    if ($this->conBDPDO()) {
                        ...
                        while ($row = $eQuery->fetch()) {
                            ...
                            $oDataSP->fechaAdquisicion = $row['CMP_Acquisition_Date'];
                            $oDataSP->nombreTecnico = $row['CMP_Technical_Name'];
                            $oDataSP->especificaciones = $row['Modelo'];
                            $oDataSP->modelo = $row['Especificaciones'];
                            $oDataSP->estado = $row['STS_Description'];
                            $oDataSP->usuario = $row['User_Username'];
        ...
        //RQ 9  Extraer datos para de la Grafica Pastel Laptops
            public function pieGraphInformationLaptop($year)
            {
                $jDatosPie = '';
                $ArrayRecordsTypeGuarantee = array();
                $i = 0;
                ...
                try {
                    $strQuery = "CALL sp_pieGraphInformationLaptos(:sp_year)";
        ...
        //RQ 10 Extraer datos para el modal del Grafica Pastel Laptos
        ...
        //RQ 11  Extraer datos para el Grafico de Dispersion
        
            public function scatterPlotInformationLocation($year)
            {
                $jDatos = '';
                ...
                try {
                    $strQuery = "CALL sp_scatterPlotInformationLocation(:sp_year)";
                    ...
                    if ($this->conBDPDO()) {
                        ...
                        while ($row = $eQuery->fetch()) {
                            ...
                            $oDataSP->CantidadRegistrosLCT = $row['CantidadRegistrosLCT'];
        ...
        //RQ 12  Extraer datos para tabla/Reporte de la Grafica De Dispersion
