...
function dataTableUser($stmt)
{
  ...
  echo " ". $row['STS_Description']. "</td>";
    ...
    echo "<td align='center'> 
            ...
            <a href='../views/view_mappingSoftware.php?p=" . $row['WR_idTbl_Warranty_Registration'] . "' class='btn btn-outline-info btn-sm' title='Más Información'>
              <iZ class='fas fa-folder'></iZ></i>
            </a>
